...
"""
import kbqa.jena_sparql_endpoint
from kbqa.others.question2sparql_bak import Question2Sparql

if __name__ == '__main__':
    # TODO 连接Fuseki服务器。
    fuseki = kbqa.jena_sparql_endpoint.JenaFuseki()
    # TODO 初始化自然语言到SPARQL查询的模块，参数是外部词典列表。
    q2s = Question2Sparql(['../kbqa/user_dicts/movie_title.txt', '../kbqa/user_dicts/person_name.txt'])
